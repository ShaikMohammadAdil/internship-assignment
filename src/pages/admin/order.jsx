    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg shadow-xl p-6 w-full max-w-md">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-xl font-bold text-blue-600">Order Details</h2>
          <button 
            onClick={onClose} 
...
const Orders = () => {
  ...
  return (
    <div className="flex">
      ...
      <Sidebar />
      <div className="flex-1 p-8 ml-[5rem] lg:ml-64 bg-blue-50 min-h-screen">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-blue-700 mb-4">Order Management</h1>
          <div className="w-full max-w-md mx-auto">
            <div className="relative">
              <input
                type="text"
                placeholder="Search by order ID or customer name..."
                className="w-full pl-10 pr-4 py-3 border-2 border-blue-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-300"
                value={searchQuery}
              ...
              <tr>
                {['orderId', 'date', 'time', 'name', 'email', 'price', 'status'].map((key) => (
                  <th 
                    ...
                    className="px-6 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wider cursor-pointer hover:bg-blue-200 transition"
                  >
