    ...
    <>
      ...
      <div className="min-h-screen bg-gray-100 flex flex-col items-center justify-center px-4 overflow-hidden relative">
        ...
        <div className="absolute inset-0 opacity-10 pointer-events-none">
          <div className="absolute top-0 left-0 w-1/2 h-1/2 bg-blue-200 rounded-full blur-3xl filter" />
        ...
        <div className="text-center z-10 max-w-md w-full p-8 bg-white rounded-xl shadow-2xl transform transition-all duration-300 hover:scale-105">
          <div className="relative">
            ...
            <div className="absolute -top-2 -right-2 w-full h-full bg-blue-100 rounded-xl -z-10 opacity-50" />
          </div>
          ...
          <Link 
            to="/"
            className="inline-flex items-center px-6 py-3 bg-blue-500 text-white font-semibold rounded-lg 
