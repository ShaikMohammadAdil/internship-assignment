      ...
      <div className="bg-gradient-to-b from-blue-50 to-indigo-100 min-h-screen">
        ...
        >
          <div className="max-w-4xl mx-auto">
            <h2 className="text-5xl font-extrabold text-blue-800 mb-4 tracking-tight">Discover Our Curated Collections</h2>
              ...
              {filteredProducts.slice(0, loadMore).map((product) => (
                ...
                >
                  ...
                  >
                    ...
                    <Link to={`/${product._id}`} className={`block ${viewMode === 'grid' ? 'mt-2' : 'mt-4'}`}>
                      <button
                        className="w-full bg-blue-50 text-blue-600 py-2 rounded-md hover:bg-blue-100 transition-colors"
