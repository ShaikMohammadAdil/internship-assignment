  ...
  return (
    ...
    <div className="bg-gradient-to-br from-blue-50 to-indigo-100 min-h-screen">
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        >
          <h1 className="text-5xl font-bold mb-4 text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-800">
            Contact Us
          </h1>
        ...
        <div className="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          >
            <div className="flex items-center mb-6">
              <FaPaperPlane className="text-indigo-600 mr-4 text-3xl" />
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all duration-300"
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                type="submit"
                className="w-full bg-gradient-to-r from-indigo-600 to-blue-700 text-white py-4 rounded-xl font-semibold hover:from-indigo-700 hover:to-blue-800 transition-all duration-300 shadow-lg"
              >
                Send Message
              </motion.button>
            </form>
          ...
          >
            <div>
              <div className="flex items-center mb-6">
                <FaMapMarkerAlt className="text-indigo-600 mr-4 text-3xl" />
              ...
              <div className="space-y-6 mb-8">
                {[ 
                  ...
                  { 
                    ...
                    title: "Email", 
                    detail: "support@saifashionzone.com" 
                  },
                  { 
                    icon: <FaMapMarkerAlt className="text-indigo-600 text-2xl" />, 
                    title: "Address", 
                    detail: "123 Fashion Street, Stylish City, NY 10001" 
                  }
                ].map((contact, index) => (
                  <motion.div 
                    key={index}
                    whileHover={{ scale: 1.05 }}
                    className="flex items-center space-x-4 bg-indigo-50 p-4 rounded-xl"
                  >
            ...
            <div className="mt-6 overflow-hidden rounded-2xl shadow-lg">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3022.982135436!2d-73.98823922400567!3d40.748817671411!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c259a9b3117469%3A0xd134e199a405a163!2sEmpire%20State%20Building!5e0!3m2!1sen!2sus!4v1675970791588!5m2!1sen!2sus"
                width="100%"
                height="300"
                allowFullScreen=""
                loading="lazy"
