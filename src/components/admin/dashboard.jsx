...
const Dashboard = () => {
        ...
        return (
            <div className="flex items-center justify-center min-h-screen bg-blue-50">
                <div className="text-center">
                    ...
                    <p className="text-blue-600 text-xl">Loading Dashboard...</p>
                </div>
            </div>
        );
    }
        ...
        return (
            <div className="flex items-center justify-center min-h-screen bg-blue-50">
                <div className="bg-white p-8 rounded-xl shadow-2xl text-center">
                    <XCircle className="mx-auto h-16 w-16 text-blue-500 mb-4" />
                    <h2 className="text-2xl font-bold text-blue-600 mb-4">Dashboard Error</h2>
    ...
    // Dashboard Render
    return (
        <div className="min-h-screen bg-blue-100 p-6 lg:p-10">
            <div className="container mx-auto">
                <div className="flex justify-between items-center mb-8">
                    <div>
                        <h1 className="text-3xl font-bold text-blue-800">Dashboard</h1>
                        <p className="text-blue-600">Welcome back to SaiFashionZone Admin!</p>
                    </div>
                    <button className="bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600 transition flex items-center" onClick={e=>{setRefresh(!refresh)}}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
                    {[
                        ...
                        <div 
                            key={index} 
                            className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow p-6 border-b-4 border-blue-500"
                        >
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {[
                        ...
                        >
                            <h2 className="text-lg font-semibold text-blue-700 mb-4">{chart.title}</h2>
                            ...
                            <div className="text-center mt-4">
                                <p className="text-3xl font-bold text-blue-600">{chart.percentage}%</p>
                                <p className="text-blue-500">{chart.description}</p>
                            </div>
                        </div>
                    ))}
                </div>
