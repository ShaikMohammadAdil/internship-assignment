...
const ProfessionalNavbar = () => {
  ...
  return (
    <nav className={`top-0 left-0 w-full z-50 transition-all duration-300 mb-auto ${
      ...
      <div 
        className={`bg-blue-600 text-white py-2 text-center text-xs transition-all duration-300 ${
      ...
      <div className="bg-white border-b">
        <div className="max-w-[1200px] mx-auto px-4 lg:px-0">
          <div className="h-[70px] flex items-center justify-between">
            ...
            <button
              onClick={toggleMenu}
              className="lg:hidden text-black hover:text-blue-600 transition"
            >
            ...
            >
              <span className="font-['Bodoni_MT'] font-bold text-2xl text-blue-600">SaiFashionZone</span>
            </Link>
            ...
            <div className="hidden lg:flex space-x-8 text-sm font-medium">
              {[
                ...
                >
                  ...
                  <span 
                    className={`
                      absolute bottom-[-4px] left-0 w-0 h-0.5 bg-blue-600 
            ...
            <div className="flex items-center space-x-6">
              ...
              <Link 
                to="/cart" 
                className="relative text-gray-800 hover:text-blue-600 transition flex items-center"
              >
                <FaShoppingCart className="w-5 h-5" />
                <span className="ml-2 hidden md:block">Cart</span>
                {cartItemCount ? (
                  <span className="absolute top-[-8px] right-[-8px] bg-blue-600 text-white rounded-full text-xs w-4 h-4 flex items-center justify-center">
                    {cartItemCount}
                  </span>
                ) : null}
              </Link>
        ...
        <div className="fixed inset-0 z-50 lg:hidden">
          ...
          >
            ...
            <div className="p-6">
              <button 
                onClick={toggleMenu} 
                className="absolute top-5 right-5 text-gray-600 hover:text-blue-600"
              >
              ...
              <div className="mt-12 space-y-4">
                {userId ? (
                  <Link
                    to="/logout"
                    onClick={handleLogout}
                    className="py-2.5 text-lg font-medium text-gray-800 hover:text-blue-600 transition flex items-center"
                  >
